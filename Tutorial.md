...
>(16) Search and retrieve orthologous gene groups among 31 soybean genomes.  
>(17) Conduct GO (gene ontology) annotation/enrichment analysis of user-input protein-coding genes in any of the 31 genomes.  
>(18) Conduct KEGG annotation/enrichment analysis of user-input protein-coding genes in any of the 31 genomes.  
...
>&emsp;&emsp;Users can input a genomic region to view and retrieve the information of genes and transposable elements in any of the 31 soybean genomes. Check the example input data to enter a genomic region in appropriate format (**Figure 3**). Steps to search any genome by location are shown in **Figure 3**.
...
>&emsp;&emsp;Users can input multiple gene IDs for any of the 31 soybean genomes to visualize the chromosome location of all input genes.
...
## **4. Browse transcription factors of a genome** <a name="tp4"></a>
>&emsp;&emsp;Users can browse transcription factors annotated in any of the 31 soybean genomes. Steps to browse the annotated transcription factors are shown in **Figure 5**.
<div align=center><img src="Fig5.png" width="100%" height="100%" align=center /></div>
<div align=center><font color=blue size=5>Figure 5. Transcription factors of Zhonghuang 13</font></div>  
...
>&emsp;&emsp;Jbrowser of all 31 high-quality soybean genomes were built to view the genome sequence, protein-coding genes, transposable elements, as well as the GO and KEGG annotations of protein-coding genes (**Figure 8**; **Figure 9**). These information are displayed in different tracks of the JBrowser.  
...
## **18. Search orthologous gene groups among 31 genomes** <a name="tp18"></a>
>&emsp;&emsp;With this functionality, users can search orthologous groups among 31 soybeans genomes by inputting a single gene ID of any of the 31 genomes (**Figure 21**). Then, orthologs of the input gene in other genomes would be displayed in the main panel after clicking the **Submit!** button.
...
>&emsp;&emsp;This functionality is used to perform GO annotation of a user-input gene list from any of the 31 soybean genomes. Five steps to conduct GO annotation are shown in **Figure 22**. The full annotation result is displayed as a table, which can be downloaded. The top 30 GO terms with the largest number of genes are displayed as a bar plot (**Figure 22**).
...
>&emsp;&emsp;This functionality is used to perform KEGG pathway annotation of a user-input gene list from any of the 31 soybean genomes. Steps to conduct KEGG annotation are shown in **Figure 24**. The full annotation result is displayed as a table, which can be downloaded. The top 30 largest KEGG pathways are displayed as a bar plot (**Figure 24**).  
...
>&emsp;&emsp;This functionality is used to perform KEGG enrichment analysis of a user-input gene list from any of the 31 soybean genomes. Steps to conduct KEGG enrichment analysis are shown in **Figure 25**. The full enrichment result is displayed as a table, and the significant enrichment result is displayed as a figure. The enrichment result can be further filtered by other parameters, including adjusted P value, Q value, etc. (**Figure 25**).  
