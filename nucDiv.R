...
# source("Global.R")
# nuc.div.plot <- nucDiv(chr="chr7", nuc.start=2800000, nuc.end=2900000, step=10, groups=c("G. Soja", "Improved cultivar"), numerator="G. Soja", denominator="Improved cultivar", mutType = NULL, snpSites = NULL)
