...
GBrowserw <- function(chr="chr15", start=1000000, end=1011111, accession=NULL, mutType=NULL) {
  ...
  snp.res <- fetchSnpw(chr=chr, start=start, end=end, accession=accession, filter = FALSE)
  ...
  snpeff.reg$tag <- ""
  snpeff.reg$tag[grepl("initiator_codon_variant&splice_region_variant", snpeff.reg$eff)] <- 27
  snpeff.reg$tag[grepl("splice_donor_variant&splice_region_variant&intron_variant", snpeff.reg$eff)] <- 26
  snpeff.reg$tag[grepl("splice_acceptor_variant&splice_region_variant&intron_variant", snpeff.reg$eff)] <- 25
  snpeff.reg$tag[grepl("splice_region_variant&stop_retained_variant", snpeff.reg$eff)] <- 24
  snpeff.reg$tag[grepl("start_lost&splice_region_variant", snpeff.reg$eff)] <- 23
  snpeff.reg$tag[grepl("start_lost", snpeff.reg$eff)] <- 22
  snpeff.reg$tag[grepl("stop_retained_variant", snpeff.reg$eff)] <- 21
  snpeff.reg$tag[grepl("stop_lost", snpeff.reg$eff)] <- 20
  snpeff.reg$tag[grepl("stop_gained&splice_region_variant", snpeff.reg$eff)] <- 19
  snpeff.reg$tag[grepl("splice_donor_variant&intron_variant", snpeff.reg$eff)] <- 18
  snpeff.reg$tag[grepl("stop_lost&splice_region_variant", snpeff.reg$eff)] <- 17
  snpeff.reg$tag[grepl("stop_gained", snpeff.reg$eff)] <- 16
  snpeff.reg$tag[grepl("splice_region_variant", snpeff.reg$eff)] <- 15
  snpeff.reg$tag[grepl("initiator_codon_variant", snpeff.reg$eff)] <- 14
  snpeff.reg$tag[grepl("missense_variant&splice_region_variant", snpeff.reg$eff)] <- 13
  snpeff.reg$tag[grepl("splice_acceptor_variant&intron_variant", snpeff.reg$eff)] <- 12
  snpeff.reg$tag[grepl("splice_region_variant&intron_variant", snpeff.reg$eff)] <- 11
  snpeff.reg$tag[grepl("5_prime_UTR_variant", snpeff.reg$eff)] <- 10
  snpeff.reg$tag[grepl("5_prime_UTR_premature_start_codon_gain_variant", snpeff.reg$eff)] <- 9
  snpeff.reg$tag[grepl("splice_region_variant&synonymous_variant", snpeff.reg$eff)] <- 8
  snpeff.reg$tag[grepl("upstream_gene_variant", snpeff.reg$eff)] <- 7
  snpeff.reg$tag[grepl("synonymous_variant", snpeff.reg$eff)] <- 6
  snpeff.reg$tag[grepl("intron_variant", snpeff.reg$eff)] <- 5
  snpeff.reg$tag[grepl("missense_variant", snpeff.reg$eff)] <- 4
  snpeff.reg$tag[grepl("3_prime_UTR_variant", snpeff.reg$eff)] <- 3
  snpeff.reg$tag[grepl("downstream_gene_variant", snpeff.reg$eff)] <- 2
  ...
  eff.tags <- c("3_prime_UTR_variant",
  ...
  eff.tags <- eff.tags[c(7,8,4,1,3,2,9,18,13,12,20,10,11,16,17,19,15,14,6,5,27,21,22,23,24,25,26)]
  names(eff.tags) <- 1:27
  ...
  if ( exists("gff") && gff[1,1]  == "Glyma.01G000050.1" ){
  }else {
    gff <- data.table::fread("./data/w82Rdata/w82.gff", sep = "\t", data.table = FALSE)
  }
  gff$id <- gsub(":.+", "", gff$id)
