...
# source("Global.R")
# ld.plot <- ld.heatmap(chr="chr2", start=17603220, end=17604802, snp.pos=c(1), gene=FALSE, ld.y=0.64, ld.w=0.80, flip=FALSE, accession=NULL, mutType=NULL, snpSites = NULL)
